              ...
              child: Row(
                children: [
                  ...
                  Expanded(
                    ...
                    children: [
                      "Abubakr".text.fontFamily(semibold).white.make(),
                      "memabubakr@gmail.com".text.white.make()
                    ],
                  )),
                ...
                builder: (BuildContext context, AsyncSnapshot snapshot) {
                  if (!snapshot.hasData) {
                    ...
                    return Row(
                      ...
                      children: [
                        Details_Cart(context.screenWidth / 3.4,
                            Countdata[0].toString(), "In your cart"),
                        Details_Cart(context.screenWidth / 3.4,
                            Countdata[1].toString(), "In your wishlsit"),
                        Details_Cart(context.screenWidth / 3.4,
